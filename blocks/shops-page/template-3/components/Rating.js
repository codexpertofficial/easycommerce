...
const StarRating = ({ rating, attributes }) => {
    const fullStar =
        EASYCOMMERCE.assets + "/common/img/blocks/shop-page/full-start-template-3.png";

    const halfStar =
        EASYCOMMERCE.assets + "/common/img/blocks/shop-page/half-start-template-3.png";

    const emptyStar =
        EASYCOMMERCE.assets + "/common/img/blocks/shop-page/empty-start-template-3.png";

    
     // Ensure starSize has a default value and proper unit
    const starSizeValue = attributes.starSize || 15;
    ...
    return (
        <div className="flex flex-row items-center gap-1 mt-2">
            ...
            <span
                ...
                style={{
                    color:
                        attributes.ratingColor || "var(--color-ec-shop3)",
