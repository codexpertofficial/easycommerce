<?php
/**
 * Render callback for the EasyCommerce Shop Template 1 block.
 *
 * This template renders the shop page layout with products, filters, and pagination.
 *
...
$cart_button_padding              	  = isset( $settings['cartButtonPadding'] ) ? intval( $settings['cartButtonPadding'] ) : 8;
$cart_button_border_radius       	  = isset( $settings['cartButtonBorderRadius'] ) ? intval( $settings['cartButtonBorderRadius'] ) : 4;
...
$checkout_button_padding              = isset( $settings['checkoutButtonPadding'] ) ? intval( $settings['checkoutButtonPadding'] ) : 12;
$checkout_button_border_radius        = isset( $settings['checkoutButtonBorderRadius'] ) ? intval( $settings['checkoutButtonBorderRadius'] ) : 6;
...
<div class="">
	...
	<div class="easycommerce-shop-container-front">
		...
		<input type="hidden" id='shop-name' name="shop-name" value="template-1">

		<!-- Filter section -->
		<?php if ( $show_filters ) : ?>
			<div class="easycommerce-drawer-container w-full">
				<?php require_once EASYCOMMERCE_PLUGIN_DIR . 'views/blocks/shops-page/template-1/inc/filter.php'; ?>
			</div>
		<?php endif; ?>


		<!-- Shop Grid -->
		<div class="w-full easycommerce-shop-container grid <?php echo esc_attr( $allowed_column_classes[ $settings['columns'] ] ?? 'grid-cols-1' ); ?> gap-[30px]">
...
<!-- Pagination -->
 <?php if( $show_pagination ) : ?>
    <div class="w-full flex justify-center items-center">
        <?php require_once EASYCOMMERCE_PLUGIN_DIR . 'views/blocks/shops-page/template-1/inc/pagination.php'; ?>
    </div>
<?php endif ?>
