<?php
/**
 * Template for rendering product shop items in Template 1.
 *
 * This template displays individual product cards with images, titles, ratings, prices, etc.
 *
 ...
 * @var string $args['shop_name'] Shop template name (e.g., 'template-1').
...
foreach ( $products as $product ) :
	...
	?>
		<div class="col-span-1 rounded-lg easycommerce-single-product">
			<div class="w-full flex items-center justify-center rounded-t-xl">
				...
				<a class="w-full inline-block overflow-hidden" href="<?php echo esc_attr( $product['link'] ); ?>"
					...
					<div class="border border-ec-border rounded-t-lg overflow-hidden relative">
						<?php
			...
			<div class="pt-4">
				...
				<div class="mt-2 mb-3 font-inter" style="
				...
				<div class="mb-2">
                   	...
                   	<?php else : ?>
                       <!-- Only Price -->
                   	 	<div class="flex items-center font-inter gap-2 flex-wrap">
                           <?php
                           if ( ! empty( $product['price'] ) ) :
                               $_product             = new Product_Model( $product['id'] );
                               $price                = $_product->get_price( false );
				...
				<div class="easycommerce-product-price-wrap flex flex-wrap gap-4 items-start">
					...
					<div class="flex justify-between items-center w-full">
						<div class="w-[50%]">
							...
							class="<?php echo esc_attr( $ec_cart_btn_class ); ?> easycommerce-button-margin easycommerce-add-to-cart-shop w-[120px] rounded-full border border-ec-border<?php echo $is_out_of_stock ? ' opacity-50 cursor-not-allowed' : ''; ?>"
					...
					<a href="<?php echo esc_attr( $product['link'] ); ?>"
						class="<?php echo esc_attr( $ec_cart_btn_class ); ?> flex items-center gap-1 px-5 py-[7px] !no-underline easycommerce-shop-choose-btn rounded-full border border-ec-border transition-all ease-in-out duration-500<?php echo $is_out_of_stock ? ' opacity-50 pointer-events-none' : ''; ?>"
