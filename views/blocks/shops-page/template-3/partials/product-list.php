<?php
/**
 * Product list view partial for Shop Template 3.
 *
 * Displays products in a list layout with detailed information for Template 3.
 *
...
$description_color                    = isset( $settings['descriptionColor'] ) ? $settings['descriptionColor'] : 'var(--color-ec-body)';
$description_font_size                = isset( $settings['descriptionFontSize'] ) ? intval( $settings['descriptionFontSize'] ) : 14;
$description_font_weight              = isset( $settings['descriptionFontWeight'] ) ? $settings['descriptionFontWeight'] : '400';
$description_text_transform           = isset( $settings['descriptionTextTransform'] ) ? $settings['descriptionTextTransform'] : 'none';
$description_style                    = isset( $settings['descriptionTextStyle'] ) ? $settings['descriptionTextStyle'] : 'none';
$description_decoration               = isset( $settings['descriptionDecoration'] ) ? $settings['descriptionDecoration'] : 'none';
$description_line_height              = isset( $settings['descriptionLineHeight'] ) ? intval( $settings['descriptionLineHeight'] ) : 20;
$description_letter_spacing           = isset( $settings['descriptionSpacing'] ) ? intval( $settings['descriptionSpacing'] ) : 0;
...
foreach ( $products as $product ) :
	...
	?>
		<div class="col-span-1 rounded-lg easycommerce-single-product p-4 list-st easycommerce-st-product-card border mb-5">
            <div class="flex w-full justify-between iteam-center">
                <div class="flex justify-start gap-4">
                    <div class="flex-shrink-0">
                        <?php if ( $product['thumbnail'] || $product['title'] ) : ?>
                        <a class="w-[203px] h-[180px] inline-block overflow-hidden" 
                        href="<?php echo esc_attr( $product['link'] ); ?>"
                        style="text-decoration: none; outline: none;">
                            <div class="rounded-md overflow-hidden h-full relative">
                                <?php
                                ...
                                // Remove the out_of_stock badge from the custom badges list.
                                ...
                                // Add the In Stock badge when enabled.
                                ...
                                <?php if ( $image_url ) : ?>
                                    <img src="<?php echo esc_url( $image_url ); ?>" 
                                        ...
                                        class="w-full h-full object-cover transition-transform duration-500 hover:scale-110 easycommerce-thumbnail-img" />
                                <?php else : ?>
                        ...
                        <div class=" mt-1">
                            <div class="">
                                <div class="flex">
                                    ...
                                    ">
                                        <a class="easycommerce-product-title-shop <?php echo $unique_class; ?> <?php echo esc_attr($title_text_transform); ?> <?php echo esc_attr( $title_decoration ); ?>"
                                        ...
                                        style="text-decoration: none; outline: none;">
                                            ...
                                            $title = $product['title'];
                                            if ( strlen( $title ) > 50 ) {
                                                echo esc_html( substr( $title, 0, 50 ) . '...' );
                                            } else {
                                                echo esc_html( $title );
                                            }
                                            ?>
                            ...
                            <?php if ( ! empty( $product['description'] ) ) :
                                ...
                                <div class="mt-2"
                                    ...
                                    font-weight: <?php echo esc_attr( $description_font_weight ); ?>;
                                    text-transform: <?php echo esc_attr( $description_text_transform ); ?>;
                                    font-style: <?php echo esc_attr( $description_style ); ?>;
                                    text-decoration: <?php echo esc_attr( $description_decoration ); ?>;
                                    line-height: <?php echo esc_attr( $description_line_height ); ?>px;
                                    letter-spacing: <?php echo esc_attr( $description_letter_spacing ); ?>px;
                                ">
                        ...
                        <div class="mt-3">
                            <?php if ( empty( $product['attributes'] ) ) : ?>
                                <div class="flex gap-3">
                                    <button data-id="<?php echo esc_attr( $product['id'] ); ?>"
                                            class="<?php echo esc_attr( $ec_cart_btn_class ); ?> easycommerce-button-margin easycommerce-add-to-cart-shop easycommerce-add-to-cart-st rounded-full<?php echo $is_out_of_stock ? ' opacity-50 cursor-not-allowed' : ''; ?>"
                            ...
                            <?php else : ?>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    class="<?php echo esc_attr( $ec_cart_btn_class ); ?> easycommerce-shop-choose-btn easycommerce-st-choose-btn rounded-full transition-all ease-in-out duration-500 !no-underline inline-flex items-center justify-center<?php echo $is_out_of_stock ? ' opacity-50 pointer-events-none' : ''; ?>"
                                    style="width:auto; min-width:144px">
                ...
                <div class="flex flex-col items-end font-inter">
                    <?php
