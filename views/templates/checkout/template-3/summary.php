...
?>
<div >
	<h3 class="easycommerce-billing-title font-inter leading-8 font-medium text-xl mb-4 text-[#272435]">
...
<div>
	...
	<div class="flex items-center justify-between p-4 border-b border-dotted border-ec-border">
		<label class="text-[#737791] font-inter font-normal text-base leading-[26px]">
			<?php esc_html_e( 'Subtotal', 'easycommerce' ); ?>
		</label>
		<span
			class="easycommerce-checkout-subtotal-price mb-0 text-[#272435] font-inter font-medium text-base leading-[26px]">
	...
	<?php if ( ! empty( $cart['fragments']['coupons'] ) ) : ?>
		<div class="flex flex-col p-4 border-b border-dotted border-ec-border easycommerce-discount-wrapper">
			<div class="text-[#737791] font-inter font-normal text-base leading-[26px]">
				<?php esc_html_e( 'Discount', 'easycommerce' ); ?>
			</div>
			<div class="ml-4 mt-2">
				<div
					class="easycommerce-checkout-discount mb-0 text-[#272435] font-inter text-base leading-[26px]">
					<?php
	...
	<div class="flex items-center justify-between p-4 border-t border-ec-border">
		<label class="text-[#272435] font-inter font-bold text-base leading-[26px]">
			<?php esc_html_e( 'Order Total', 'easycommerce' ); ?>
		</label>
		<span
			class="easycommerce-checkout-total mb-0 text-[#272435] font-inter font-bold text-base leading-[26px]">
