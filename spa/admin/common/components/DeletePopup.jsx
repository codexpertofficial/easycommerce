        ...
        <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-[#00000082] backdrop-blur-sm z-[999999]">
            <div className="relative w-[451px] flex flex-col justify-center items-center bg-white rounded-[22px] pb-[40px]">
                ...
                >
                    ...
                    >
                        <img src={deleteImage} alt="delete-attribute" className="w-[80px] h-[80px]" />
                    </div>
                    <button 
                        onClick={onClose} 
                ...
                {isProduct && !forceDelete && 
                    <button 
                        className="mx-auto mt-3 cursor-pointer font-inter font-normal text-base text-ec-placeholder underline hover:text-[#FF3A52] duration-300"
