                    ...
                    <div key={index} className="flex flex-col justify-between h-[144px] bg-white rounded-lg border border-transparent hover:border-ec-table-stock duration-300 p-5 hover:shadow-[0px_4px_10px_0px_#0000001A]">
                        <div className="flex justify-between">
                            <div className="flex gap-3">
                                <div className="rounded-[10px] bg-[#F3F3FF] flex items-center justify-center w-10 h-10 shrink-0">
                                    <img src={EASYCOMMERCE.assets + 'admin/img/reports/' + data.icon + '.svg'} alt="" />
                                </div>
                                <h6 className='text-base font-medium text-[#3C3C42] pr-1'>{data.title}</h6>
                            </div>
                        ...
                        <div className="flex justify-between items-end">
                            <h5 className='text-2xl font-medium text-[#282828]'>
