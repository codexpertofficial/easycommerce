...
const Categories = ({page}) => {
    ...
    const flattenCategories = (categories, parentName = 'None', parentId = 0) => {
        let flatList = [];
            ...
            <div className="grid grid-cols-12 gap-6 items-start">
                ...
                <div className="bg-white ec-db-lg:col-span-4 col-span-5 w-full self-start border border-solid border-ec-table-stock rounded-xl">
                    ...
                    <div className="p-6 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <SubTitle SubTitle="Slug" notice="URL-friendly slug of the category" />
                        ...
                        <div className='flex flex-col gap-2'>
                            <SubTitle SubTitle="Parent" notice="Select a parent category if any" />
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            <Button
                                ...
                                value={editingCategory ? "Update Category" : "Create Category"}
